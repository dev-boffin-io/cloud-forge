#!/usr/bin/env bash
# =============================================================
#  cloud-forge — GUI System Dependency Installer
#  Run once as root/sudo before building.
#  Usage: sudo ./build/install-deps-gui.sh
# =============================================================
set -euo pipefail
...
header "cloud-forge — GUI Dependency Installer ($PKG_MGR)"
...
case "$PKG_MGR" in
    ...
    apk)
        ...
        ;;
    *)
        die "Unsupported package manager.\n   Install manually: python3-pyqt5  libGL  libxcb-xinerama"
        ;;
esac
...
# Detect python binary for verify step
PY_BIN=""
...
printf "\n${BOLD}Next step:${RESET} ${BLUE}./build/build-gui.sh${RESET}\n\n"
